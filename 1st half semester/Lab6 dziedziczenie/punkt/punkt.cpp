...
Punkt::Punkt():x(0),y(0){
  cout << "Konstruktor bezparametrowy z klasy Punkt" << endl;
}

Punkt::Punkt(double _x, double _y){
  cout << "Konstruktor parametrowy z klasy Punkt" << endl;
  x = _x;
  y = _y;
}
...
this->x = punkt.x;
this->y = punkt.y;
cout << "Konstruktor kopiujacy z klasy Punkt!" << endl;
}

Punkt::~Punkt(){
  cout << "Destruktor z klasy Punkt" << endl;
}
