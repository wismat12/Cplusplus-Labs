...
inline void DivisionByZeroException::printMessage()
{
    ...
    obj1.print();
    cout << "Dzia³ania poprowadza do sytuacji dzielenia przez zero!" << endl;
...
private:
    int a;
public:
    ComplexDivisonByZeroExp(){}
    void printMessage();
};
inline void ComplexDivisonByZeroExp::printMessage()
{
    cout << "Podczas przeprowadzania obliczen wykryto liczbe rowna zero, \nCo uniemozliwia dzielenie i konytuowanie programu!"
}
