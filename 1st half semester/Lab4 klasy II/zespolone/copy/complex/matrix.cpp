...
Matrix Matrix::Inverse(Matrix m)
{
   ...
   // maindet.print();
    ...
    Matrix cofactor_mxT = cofactor_mx.transpose(cofactor_mx);
    cout << "Transponuje!!!" << endl;
    cofactor_mxT.print();
    cout << "JUZ" << endl;


    Complex maindet_inv = maindet.inv();
    maindet_inv.print();
    cout << "Wyznacznik odwrocony!!!" << endl;

    cofactor_mxT.print();

    Matrix cofactor_mxT_inv = cofactor_mxT.mul(maindet_inv);
